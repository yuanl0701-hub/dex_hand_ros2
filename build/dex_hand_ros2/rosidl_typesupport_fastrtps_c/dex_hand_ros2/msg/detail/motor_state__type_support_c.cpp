...
#include "dex_hand_ros2/msg/detail/motor_state__rosidl_typesupport_fastrtps_c.h"
...
using _MotorState__ros_msg_type = dex_hand_ros2__msg__MotorState;
...
size_t get_serialized_size_dex_hand_ros2__msg__MotorState(
  const void * untyped_ros_message,
...
static uint32_t _MotorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dex_hand_ros2__msg__MotorState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dex_hand_ros2
size_t max_serialized_size_dex_hand_ros2__msg__MotorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MotorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dex_hand_ros2__msg__MotorState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dex_hand_ros2, msg, MotorState)() {
