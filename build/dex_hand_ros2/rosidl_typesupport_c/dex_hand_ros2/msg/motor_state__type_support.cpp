...
static const _MotorState_type_support_symbol_names_t _MotorState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dex_hand_ros2, msg, MotorState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dex_hand_ros2, msg, MotorState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dex_hand_ros2, msg, MotorState)() {
  return &::dex_hand_ros2::msg::rosidl_typesupport_c::MotorState_message_type_support_handle;
}
