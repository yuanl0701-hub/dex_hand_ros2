...
#ifndef DEX_HAND_ROS2__SRV__DETAIL__ADD_GESTURE__FUNCTIONS_H_
#define DEX_HAND_ROS2__SRV__DETAIL__ADD_GESTURE__FUNCTIONS_H_
...
/// Initialize srv/AddGesture message.
/**
...
/// Finalize srv/AddGesture message.
/**
...
/// Create srv/AddGesture message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dex_hand_ros2__srv__AddGesture_Request__init().
...
/// Destroy srv/AddGesture message.
/**
 * It calls
 * dex_hand_ros2__srv__AddGesture_Request__fini()
...
/// Check for srv/AddGesture message equality.
/**
...
/// Initialize array of srv/AddGesture messages.
/**
...
/// Finalize array of srv/AddGesture messages.
/**
 * It calls
 * dex_hand_ros2__srv__AddGesture_Request__fini()
...
/// Create array of srv/AddGesture messages.
/**
 * It allocates the memory for the array and calls
 * dex_hand_ros2__srv__AddGesture_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AddGesture messages.
/**
 * It calls
 * dex_hand_ros2__srv__AddGesture_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AddGesture message array equality.
/**
...
/// Copy an array of srv/AddGesture messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dex_hand_ros2__srv__AddGesture_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dex_hand_ros2
...
/**
 * It calls
 * dex_hand_ros2__srv__AddGesture_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dex_hand_ros2
...
/**
 * It allocates the memory for the array and calls
 * dex_hand_ros2__srv__AddGesture_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dex_hand_ros2
...
/**
 * It calls
 * dex_hand_ros2__srv__AddGesture_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DEX_HAND_ROS2__SRV__DETAIL__ADD_GESTURE__FUNCTIONS_H_
