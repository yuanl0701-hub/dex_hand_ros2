...
static const _MotorState_type_support_symbol_names_t _MotorState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dex_hand_ros2, msg, MotorState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dex_hand_ros2, msg, MotorState)),
  }
};
...
{
  return &::dex_hand_ros2::msg::rosidl_typesupport_cpp::MotorState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dex_hand_ros2, msg, MotorState)() {
  return get_message_type_support_handle<dex_hand_ros2::msg::MotorState>();
}
