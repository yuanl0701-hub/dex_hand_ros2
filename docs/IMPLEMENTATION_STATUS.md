...
| Automated tests | Implemented and verified | 75 pure tests pass locally; historical 69-test Humble package run passed before the latest partial-operation change | `test/` | Latest ROS build and hardware tests pending | Rebuild on target and run physical acceptance suite |
